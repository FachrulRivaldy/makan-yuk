...
List<Restaurant> restaurants = const [
  Restaurant(
      ...
      rating: 4.5,
      detail:
          "Tokyo Cuisine adalah restoran bintang 5 yang memiliki tema Jepang serta menyajikan menu Jepang dengan nuansa dan dekorasi yang membuat pengunjung dapat merasakan suasana Jepang"),
  Restaurant(
      ...
      rating: 4.8,
      detail:
          "Italian Resto adalah restoran bintang 5 yang memiliki tema Italia serta menyajikan menu Italia dengan nuansa dan dekorasi yang membuat pengunjung dapat merasakan suasana Italia"),
  Restaurant(
